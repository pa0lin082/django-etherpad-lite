...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PadGroup.groupName'
        db.add_column(u'etherpadlite_padgroup', 'groupName',
                      self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=256),
                      keep_default=False)


        # Changing field 'PadGroup.group'
        db.alter_column(u'etherpadlite_padgroup', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'], null=True))

    def backwards(self, orm):
        # Deleting field 'PadGroup.groupName'
        db.delete_column(u'etherpadlite_padgroup', 'groupName')


        # Changing field 'PadGroup.group'
        db.alter_column(u'etherpadlite_padgroup', 'group_id', self.gf('django.db.models.fields.related.ForeignKey')(default=datetime.datetime(2016, 1, 18, 0, 0), to=orm['auth.Group']))
    ...
    models = {
        ...
        u'etherpadlite.padgroup': {
            ...
            'groupName': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '256'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'server': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['etherpadlite.PadServer']"})
        },
