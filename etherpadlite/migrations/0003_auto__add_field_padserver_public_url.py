...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PadServer.public_url'
        db.add_column(u'etherpadlite_padserver', 'public_url',
                      self.gf('django.db.models.fields.URLField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PadServer.public_url'
        db.delete_column(u'etherpadlite_padserver', 'public_url')
    ...
    models = {
        ...
        u'etherpadlite.padserver': {
            ...
            'public_url': ('django.db.models.fields.URLField', [], {'max_length': '256', 'null': 'True', 'blank': 'True'}),
